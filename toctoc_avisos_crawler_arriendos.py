...
timeout = 30
localizacion_busqueda = "Santiago, Región Metropolitana"
salida = "./stgo_rm.csv"
...
print('**************************************')
print('')
print('Buscando avisos de arriendos activos en: ' + str(localizacion_busqueda) + '.')
print('')

boton_arriendos = driver.find_element_by_xpath("//div[@id='tipoBusca']/label[2]")
boton_arriendos.click()
